...
function getButtonsForSection(section) {
    const buttons = {
        ...
        englishWebNavigation: ['Register', 'Medical Packages', 'Pharmacy', 'Prescription History', 'Payment History', 'User Profile', ],
        sinhalaWebNavigation: ['ලියාපදිංචි කරන්න', 'වෛද්‍ය පැකේජ', 'ෆාමසිය', 'බෙහෙත් වට්‍ටෝරු ඉතිහාසය', 'ගෙවීම් ඉතිහාසය', 'පරිශීලක පැතිකඩ', ],
        tamilWebNavigation: ['பதிவு', 'மருத்துவ தொகுப்புகள்', 'மருந்தகம்', 'மருந்து வரலாறு', 'கட்டண வரலாறு', 'பயனர் சுயவிவரம்', ],
        ...
        englishRegister: ['Web Navigation', 'Find Doctor', 'Customer Care'],
        sinhalaRegister: ['වෙබ් සංචාලනය', 'වෛද්‍යවරයා සොයන්න', 'පාරිභෝගික සේවාව'],
        tamilRegister: ['வலை வழிசெலுத்தல்', 'டாக்டரைக் கண்டுபிடி', 'வாடிக்கையாளர் பராமரிப்பு'],
    };
